...
# Timer
obstcatle_timer = pygame.USEREVENT + 1
pygame.time.set_timer(obstcatle_timer, 1500)
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == obstcatle_timer and game_active:
            if randint(0, 2):
